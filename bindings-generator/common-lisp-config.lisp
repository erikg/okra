...
(defparameter *lisp-type-mapping*
  '(;; standard types
    ...
    ("BoneAssignmentIterator" . cl-pointer)
    ...
    ("LodDistanceIterator" . cl-pointer)
    ("MaterialPtr" . cl-pointer)
    ("Matrix3" . cl-array9)
    ("MeshPtr" . cl-pointer)
    ...
    ("SubMeshIterator" . cl-pointer)
    ("TechniqueIterator" . cl-pointer)
    ("TemplateIterator" . cl-pointer)
    ("HardwareBuffer::Usage" . cl-stub)
    ("UTFString" . cl-string)
    ("Vector2" . cl-array2)
    ("Vector3" . cl-array3)
    ("Vector4" . cl-array4)
    ("ProgressiveMesh::VertexReductionQuota" . cl-stub)
    ...
    ("const SceneBlendFactor" . cl-scene-blend-factor)
    ("const SceneBlendType" . cl-scene-blend-type)
    ("const String&" . cl-string)
