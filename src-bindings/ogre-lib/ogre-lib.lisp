...
(define-foreign-type okra-array2 ()
  ()
  (:actual-type :pointer)
  (:simple-parser okra-array2))
...
(define-foreign-type okra-array9 ()
  ()
  (:actual-type :pointer)
  (:simple-parser okra-array9))
...
(defmethod free-translated-object (pointer (value okra-array2) param)
...
(defmethod free-translated-object (pointer (value okra-array9) param)
  (declare (ignore param))
  (foreign-free pointer))
...
(defmethod translate-to-foreign (a2 (type okra-array2))
  (foreign-alloc 'okra-real :initial-contents
                 (list (elt a2 0) (elt a2 1))))
...
(defmethod translate-to-foreign (a9 (type okra-array9))
  (foreign-alloc 'okra-real :initial-contents
           (list (elt a9  0) (elt a9  1) (elt a9  2)
                 (elt a9  3) (elt a9  4) (elt a9  5)
                 (elt a9  6) (elt a9  7) (elt a9  8))))
