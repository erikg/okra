...
;;
(defcfun "ogre_node_set_orientation"
    :void
  (ogre-node :pointer)
  (q okra-array4))

(defmethod set-orientation ((this node) q)
  (ogre-node-set-orientation (pointer-to this) q))
...
;;
(defcfun "ogre_node_set_position"
    :void
  (ogre-node :pointer)
  (pos okra-array3))

(defmethod set-position ((this node) pos)
  (ogre-node-set-position (pointer-to this) pos))
...
;;
(defcfun "ogre_node_set_scale"
    :void
  (ogre-node :pointer)
  (scale okra-array3))

(defmethod set-scale ((this node) scale)
  (ogre-node-set-scale (pointer-to this) scale))
...
;; args: (("const Vector3&" . "scale"))
;;
(defcfun "ogre_node_scale"
    :void
  (ogre-node :pointer)
  (scale okra-array3))

(defmethod scale ((this node) scale)
  (ogre-node-scale (pointer-to this) scale))
...
;;
(defcfun "ogre_node_translate"
    :void
  (ogre-node :pointer)
  (d okra-array3)
  (relative-to :pointer))

(defmethod translate ((this node) d relative-to)
  (ogre-node-translate (pointer-to this) d relative-to))
...
(defmethod get-local-axes ((this node))
  (ogre-node-get-local-axes (pointer-to this)))
...
;;
(defcfun "ogre_node_create_child"
    :pointer
  (ogre-node :pointer)
  (name :string)
...
(defmethod create-child ((this node) name translate rotate)
  (ogre-node-create-child (pointer-to this) name translate rotate))
...
;;
(defcfun "ogre_node_get_child"
    :pointer
  (ogre-node :pointer)
  (name :string))

(defmethod get-child ((this node) name)
  (ogre-node-get-child (pointer-to this) name))
...
;; args: (("const String&" . "name"))
;;
(defcfun "ogre_node_remove_child"
    :pointer
  (ogre-node :pointer)
  (name :string))

(defmethod remove-child ((this node) name)
  (ogre-node-remove-child (pointer-to this) name))
