...
;;;; but it gvies better optimisation in SBCL for me than just putting a
...
(defparameter +g2*2+ (* 2.0 0.211324865))

(defparameter +f3+ 0.333333333)
(defparameter +g3+ 0.166666667)
(defparameter +g3*2+ (* 2.0 0.166666667))
(defparameter +g3*3+ (* 3.0 0.166666667))
